            ...
            <div className="card-content white-text">
              <form className="container">
                <div className="row">
                  ...
                  <label for="userID" className="white-text">
                    User ID:
                  </label>
                  <div className="input-field col m12 white">
                    <input className="validate" type="text" name="userID" />
                  </div>
                </div>
                <div className="row ">
                ...
                <div className="row center-align" id="buttonsBox">
                    <div className=" offset-s2">

                    </div>
                  <input className="loginButton" type="button" value="Login"                       id="loginlog"/>
