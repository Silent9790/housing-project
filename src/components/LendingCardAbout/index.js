...
<div className="row">
    <div className="card red darken-4">
        <div className="card-content white-text">
            ...
            <p>Home Loans up to $567,500 (or appraised value, whichever is less) at 1% interest are available for purchases within a 30-mile radius of the former tribal hall chimney (located at 39015 172nd Avenue SE, Auburn, Washington 98092). </p><br />
            <p>ELIGIBILITY: Limited to tribal members who are home owner-occupants, have completed the Housing Authority's home buyer training course, and meet income, down payment, and credit conditions, which financially satisfy the MHLP loan requirements.</p>
        </div>
